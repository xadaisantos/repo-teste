...
<body>
    ...
    <div>
        ...
        <div>
            <div>Titulo:</div>
            <div><input name="titulo" id="titulo" type="text" value="{{ $livro->titulo }}"></div>
        </div>
        <div>
            <div>ISBN:</div>
            <div><input name="isbn" id="isbn" type="text" value="{{ $livro->isbn }}"></div>
        </div>
        <div>
            <div>Nome do Autor:</div>
            <div><input name="nome_autor" id="nome_autor" type="text" value="{{ $livro->nome_autor }}"></div>
        </div>
        <div>
            <div>Ano de Lancamento:</div>
            <div><input name="ano_lancamento" id="ano_lancamento" type="number" value="{{ $livro->ano_lancamento }}"></div>
        </div>
        <br>
        <button onclick="enviar({{ $livro->id }})">Enviar</button>
    </div>
    <script>
        function enviar(id){
            let livro = {
